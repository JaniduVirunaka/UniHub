  ...
  if (!sport) {
    return (
      <PageWrapper title="Sport Details" subtitle="Requested sport could not be found.">
        <GlassCard><p className="text-slate-300">Sport not found.</p></GlassCard>
      </PageWrapper>
    );
  }
    ...
    <PageWrapper title={sport.name} subtitle="Review the sport details and submit your join request.">
      <div className="grid gap-6 xl:grid-cols-[1fr_1.1fr]">
        <GlassCard className="h-fit">
          ...
          <p className="mt-3 leading-7 text-slate-300">{sport.description || "No description available for this sport yet."}</p>
        ...
        <GlassCard>
          ...
          <p className="mt-2 text-sm leading-6 text-slate-300">Fill in your student and physical details carefully before submitting your request.</p>
          <form onSubmit={handleSubmit} className="mt-6 grid gap-4 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              <label className="mb-2 block text-sm font-medium text-slate-200">Extra Skills</label>
              <textarea
                name="extraSkills"
