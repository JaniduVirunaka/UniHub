...
function SportsList() {
  ...
  if (loading) {
    return (
      <PageWrapper title="Explore Sports" subtitle="Browse all available sports and find the team you want to join.">
  ...
  return (
    <PageWrapper title="Explore Sports" subtitle="Browse all available sports and choose the team that matches your skills and interests.">
      {sports.length === 0 ? (
          ...
          {sports.map((sport) => (
            <GlassCard key={sport._id} className="relative transition hover:-translate-y-1 hover:z-10 hover:bg-white/10">
              ...
              <Link
                ...
                className="mt-6 inline-flex items-center gap-2 rounded-2xl bg-emerald-500 px-4 py-3 font-semibold text-white transition hover:bg-emerald-600 dark:bg-emerald-400 dark:text-slate-950 dark:hover:bg-emerald-300"
              >
                View Details
                <ArrowRight size={16} />
              </Link>
