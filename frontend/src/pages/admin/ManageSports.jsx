...
function ManageSports() {
  ...
  if (loading) {
    return (
      <PageWrapper
        title="Manage Sports"
        subtitle="Edit, review, and remove sports from the system."
      >
  ...
  return (
    <PageWrapper
      title="Manage Sports"
      subtitle="Keep the sports catalog updated and well organized."
    >
      {sports.length === 0 ? (
        <GlassCard>
              ...
              {editingId === sport._id ? (
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    <button
                      onClick={() => handleUpdate(sport._id)}
                      className="flex-1 rounded-2xl bg-emerald-400 px-4 py-3 font-semibold text-slate-950 transition hover:bg-emerald-300"
                    >
                      Save
                    </button>
                    <button
                ...
                <>
                  ...
                  <p className="mt-3 min-h-[70px] text-sm leading-6 text-slate-300">
                    {sport.description || "No description available."}
                  </p>
                  <p className="mt-2 text-sm text-cyan-300">
                    Category: {sport.category || "Not specified"}
                  </p>

                  <div className="mt-6 flex gap-3">
                    <button
                      onClick={() => startEdit(sport)}
                      className="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl bg-cyan-400/15 px-4 py-3 font-semibold text-cyan-300 transition hover:bg-cyan-400/25"
                    >
                      <Pencil size={16} />
                      Edit
                    </button>
                    ...
                    <button
                      ...
                      className="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl bg-rose-400/15 px-4 py-3 font-semibold text-rose-300 transition hover:bg-rose-400/25"
                    >
                      <Trash2 size={16} />
                      Delete
                    </button>
